...
train_data_file = open('Pro_137_Project_Boilerplate-main\intents.json')
...
def preprocess_train_data():
    ...
    stem_words, tag_classes, word_tags_list = create_bot_corpus( pattern_word_tags_list, ignore_words)
